...
db.exec(`
CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, nom TEXT NOT NULL, prenom TEXT NOT NULL, numero TEXT NOT NULL, email TEXT UNIQUE NOT NULL, etablissement TEXT, niveau TEXT, is_etudiant INTEGER DEFAULT 1, password_hash TEXT NOT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP, is_active INTEGER DEFAULT 1, local_uid TEXT UNIQUE, synced INTEGER DEFAULT 0);
...
ensureColumn('users', 'local_uid', 'local_uid TEXT');
ensureColumn('users', 'synced', 'synced INTEGER DEFAULT 0');
ensureColumn('loans', 'local_uid', 'local_uid TEXT');
