    ...
    <>
      ...
      <div className="admin-layout">
        <aside className="admin-sidebar">
          ...
          <Link href="/" className="admin-home-btn" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 14px', borderRadius: '8px', color: '#cbd5e1', textDecoration: 'none', fontSize: '14px', fontWeight: 500, marginTop: 'auto' }}><Icon name="book" size={16} /> <span>Retour a l'accueil</span></Link>
